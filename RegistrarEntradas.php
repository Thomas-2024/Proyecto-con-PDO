...
<form action="" method="post">
    ...
    <input type="text" id="nuevo_producto" id="" disabled style="display: none;">
    <select id="existente_producto" id="" disabled style="display: none;">
        <?php
    ...
    Nuevo: <input type="radio" name="opcion_categoria" value="nuevo" onchange="MostrarNuevo('categoria')">
    Existente <input type="radio" name="opcion_categoria" value="existente" onchange="MostrarExistente('categoria')">
    <input type="text" id="nuevo_categoria" id="" disabled style="display: none;">
    <select id="existente_categoria" id="" disabled style="display: none;">
        <?php
    ...
    Nuevo: <input type="radio" name="opcion_proveedor" value="nuevo" onchange="MostrarNuevo('proveedor')">
    Existente <input type="radio" name="opcion_proveedor" value="existente" onchange="MostrarExistente('proveedor')">
    <input type="text" id="nuevo_proveedor" id="" disabled style="display: none;">
    <select id="existente_proveedor" id="" disabled style="display: none;">
        <?php
