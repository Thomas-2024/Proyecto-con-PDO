<?php
    try {
        ...
        if ($fila['Modificar_Productos'] === 'SI'){
            echo "Rol con permisos para modificar productos <br>";
            echo "<script>
                document.getElementById('Menu-Productos').style.display = 'block'
            </script>";
        } else {
            echo "Rol sin permisos para modificar productos <br>";
        }
