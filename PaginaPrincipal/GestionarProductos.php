<?php 
    ...
    $conexion=MiConexion();
    $sentencia_categoria =$conexion->prepare("SELECT I.id_categoria, C.id_categoria, C.categoria FROM inventario I INNER JOIN categoria C ON I.id_categoria = C.id_categoria");
